...
export type SaveCodesRequestType = {
  codesIds: number[];
  subscribeId: number;
};
// -----------------------------------------
...
export type UpgradeSubRequestType = {
  productId: number;
  subscribeId: number;
};
// ---------------------------
...
export type UpgradeSubActionType = ReturnType<typeof upgradeSubAction>;
export type SaveCodesActionType = ReturnType<typeof saveCodesAction>;
